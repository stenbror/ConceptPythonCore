...
namespace PythonCore::Runtime
{
    ...
    class ASTImportStatementNode : public ASTStatementNode
    {
        public:
            ASTImportStatementNode(unsigned int start, unsigned int end, std::shared_ptr<Token> op1, std::shared_ptr<ASTStatementNode> right);
            std::shared_ptr<Token> getOperatorOne();
            std::shared_ptr<ASTStatementNode> getRight();
    ...
    class ASTFromImportStatementNode : public ASTStatementNode
    {
        public:
            ASTFromImportStatementNode( unsigned int start,
                                        unsigned int end,
                                        std::shared_ptr<Token> op1,
                                        std::shared_ptr<std::vector<std::shared_ptr<Token>>> dots,
                                        std::shared_ptr<ASTStatementNode> left,
    ...
    class ASTFuncTypeExpressionNode : public ASTExpressionNode
    {
        public:
            ASTFuncTypeExpressionNode(  unsigned int start, 
                                        unsigned int end, 
                                        std::shared_ptr<Token> op1, 
                                        std::shared_ptr<ASTExpressionNode> left, 
                                        std::shared_ptr<Token> op2, 
    ...
    class ASTTypeListExpressionNode : public ASTExpressionNode
    {
        public:
