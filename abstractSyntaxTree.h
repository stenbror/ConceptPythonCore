    ...
    class ASTNode
    {
        public:
            enum class NodeKind
            {
                ...
                NK_OR, NK_XOR, NK_AND, NK_SHIFT_LEFT, NK_SHIFT_RIGHT, NK_PLUS_NK_MINUS, NK_MUL, NK_DIV, NK_FLOOR_DIV, NK_MODULO,
                ...
                NK_EXPR_LIST, NK_TEST_LIST, NK_SYNC_COMP_FOR, NK_COMP_FOR, NK_COMP_IF, NK_YIELD, NK_YIELD_FROM,
